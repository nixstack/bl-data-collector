...
@SpringBootTest
public class LogSimulationTest {
    private  final static Logger logger = LoggerFactory.getLogger(LogSimulationTest.class);
    ...
    private void generateLog(Long delay, int loop_len) {
    ...
    private Object genPageDetailLog() {
    ...
    private Object packEventToJson(String eventName, Object json) {
